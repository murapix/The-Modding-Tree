...
function respecBuyables(layer) {
	...
	if ((tmp[layer].buyables.respecConfirm === undefined || tmp[layer].buyables.respecConfirm) && !player[layer].noRespecConfirm && !confirm(tmp[layer].buyables.respecMessage || "Are you sure you want to respec? This will force you to do a \"" + (tmp[layer].name ? tmp[layer].name : layer) + "\" reset as well!")) return
